const dogs = [
    {id: 1, name: 'Max', size: 'malá', sex: 'pes', photo: 'images/dogs/dog1.jpg', age: '3 roky', shelterDuration: '3 roky',
    ...
    { id: 2, name: 'Bella', size: 'stredná', sex: 'fenka', photo: 'images/dogs/dog2.jpg', age: '2 roky', shelterDuration: '2 rokz',
    ...
    { id: 3, name: 'Charlie', size: 'malá', sex: 'pes', photo: 'images/dogs/dog3.jpg', age: '4 roky', shelterDuration: '1,5 roka',
    ...
    { id: 4, name: 'Lucy', size: 'veľká', sex: 'fenka', photo: 'images/dogs/dog4.jpg', age: '5 rokov', shelterDuration: '3 roky',
    ...
    { id: 5, name: 'Daisy', size: 'stredná', sex: 'fenka', photo: 'images/dogs/dog5.jpg', age: '1 rok' ,shelterDuration: '1 rok',
    ...
    { id: 6, name: 'Draco', size: 'veľká', sex: 'pes', photo: 'images/dogs/dog6.jpg', age: '3 roky', shelterDuration: '3 roky',
    ...
    { id: 7, name: 'Viki', size: 'malá', sex: 'fenka', photo: 'images/dogs/dog7.jpg', age: '1 rok', shelterDuration: '1 rok',
    ...
    { id: 8, name: 'Leila', size: 'veľká', sex: 'fenka', photo: 'images/dogs/dog8.jpg', age: '4 roky' , shelterDuration: '4 roky',
    ...
    { id: 9, name: 'Gimy', size: 'stredná', sex: 'pes', photo: 'images/dogs/dog9.jpg', age: '1 rok' , shelterDuration: 'pol roka',
    ...
    { id: 10, name: 'Ricky', size: 'veľká', sex: 'pes', photo: 'images/dogs/dog10.jpg', age: '6 rokov', shelterDuration: '1 rok',
    ...
    { id: 11, name: 'Edina', size: 'malá', sex: 'fenka', photo: 'images/dogs/dog11.jpg', age: '2 roky', shelterDuration: '1,5 roka',
    ...
    { id: 12, name: 'Henry', size: 'stredná', sex: 'pes', photo: 'images/dogs/dog12.jpg', age: '3 roky', shelterDuration: '3 roky',
    ...
    { id: 13, name: 'Hektor', size: 'stredná', sex: 'pes', photo: 'images/dogs/dog13.jpg', age: '2 roky' , shelterDuration: '2 roky',
    ...
    { id: 14, name: 'Lily', size: 'malá', sex: 'fenka', photo: 'images/dogs/dog14.jpg', age: '1 rok' , shelterDuration: '1',
    ...
    { id: 15, name: 'Heidy', size: 'veľká', sex: 'fenka', photo: 'images/dogs/dog15.jpg', age: '6 rokov', shelterDuration: '2 roky',
    ...
    { id: 16, name: 'Romeo', size: 'stredná', sex: 'pes', photo: 'images/dogs/dog16.jpg', age: '3 roky', shelterDuration: '3 roky',
    ...
    { id: 17, name: 'Luna', size: 'veľká', sex: 'fenka', photo: 'images/dogs/dog17.jpg', age: '4 roky', shelterDuration: '3 roky',
    ...
    { id: 18, name: 'Jeffrey', size: 'malá', sex: 'pes', photo: 'images/dogs/dog18.jpg', age: '2 roky', shelterDuration: '2 roky',
    ...
    { id: 19, name: 'Nox', size: 'malá', sex: 'pes', photo: 'images/dogs/dog19.jpg', age: '1 rok', shelterDuration: '1 rok',
    ...
    { id: 20, name: 'Egon', size: 'veľká', sex: 'pes', photo: 'images/dogs/dog20.jpg', age: '6 rokov', shelterDuration: 'pol roka',
    ...
    { id: 21, name: 'Fred', size: 'veľká', sex: 'pes', photo: 'images/dogs/dog21.jpg', age: '8 rokov', shelterDuration: '8 rokov',
    ...
    { id: 22, name: 'Jamie', size: 'malá', sex: 'fenka', photo: 'images/dogs/dog22.jpg', age: '3 roky' , shelterDuration: '2 roky',
    ...
    { id: 23, name: 'Noeli', size: 'malá', sex: 'fenka', photo: 'images/dogs/dog23.jpg', age: '1 rok', shelterDuration: '1 rok',
    ...
    { id: 24, name: 'Maxim', size: 'stredná', sex: 'pes', photo: 'images/dogs/dog24.jpg', age: '4 roky' , shelterDuration: '2 roky',
...
const cats = [
    { id: 1, name: 'Chelsy', size: 'stredná', sex: 'mačka', photo: 'images/cats/cat1.jpg', age: '3 roky', shelterDuration: '2 roky',
    ...
    { id: 2, name: 'Barbie', size: 'stredná', sex: 'mačka', photo: 'images/cats/cat2.jpg', age: '2 roky', shelterDuration: '2 roky',
    ...
    { id: 3, name: 'Timothe', size: 'stredná', sex: 'kocúr', photo: 'images/cats/cat3.jpg', age: '4 roky', shelterDuration: '1 rok',
    ...
    { id: 4, name: 'Zara', size: 'malá', sex: 'mačka', photo: 'images/cats/cat4.jpg', age: '1 rok', shelterDuration: '1 rok',
    ...
    { id: 5, name: 'Rafi', size: 'stredná', sex: 'kocúr', photo: 'images/cats/cat5.jpg', age: '3 roky', shelterDuration: '3 roky',
    ...
    { id: 6, name: 'Lucky', size: 'malá', sex: 'kocúr', photo: 'images/cats/cat6.jpg', age: '1 rok', shelterDuration: '1 rok',
    ...
    { id: 7, name: 'Jessica', size: 'stredná', sex: 'mačka', photo: 'images/cats/cat7.jpg', age: '4 roky' , shelterDuration: '3 roky',
    ...
    { id: 8, name: 'Tito', size: 'stredná', sex: 'kocúr', photo: 'images/cats/cat8.jpg', age: '5 rokov', shelterDuration: '3 roky',
